...
func LoadConfig() (*Config, error) {
	...
	err := k.Load(env.Provider("SNAPTASK_", ".", func(s string) string {
		return strings.ToLower(strings.TrimPrefix(s, "SNAPTASK_"))
	}), nil)
	if err != nil {
	...
	mainConfig.Observability.ServiceName = "snaptask"
